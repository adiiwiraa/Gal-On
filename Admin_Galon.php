...
<body>
  ...
  <div class="services_section layout_padding">
    <div class="container">
      ...
      <p class="services_text">Stok Galon yang tersedia</p>
      <table class="table">
        <thead>
          <tr>
        ...
        <tbody>
          ...
          $sql = "SELECT supplier.Nama_Supplier,barang.ID_Barang, barang.Tipe_Barang, barang.Harga_Barang , barang.Stok FROM supplier JOIN barang ON supplier.ID_Supplier = barang.ID_Supplier ORDER BY supplier.Nama_Supplier ASC";
          ...
          if ($result->num_rows > 0) {
            ...
            foreach ($data as $id_barang => $rows) {
              echo "<tr>";
              echo "<td rowspan='" . count($rows) . "' id='id_barang'>" . $id_barang . "</td>";

              foreach ($rows as $index => $row) {
                // if ($index > 0) {
                //     echo "<tr>";
                // }
                echo "<td id='suplier'>" . $row['supplier'] . "</td>";
        ...
        <tfoot>
          <tr>
            <td>
              <a href="Admin_Galon_Delete.php">
                <button class="btn btn-primary">Hapus Data</button>
              </a>

            </td>
            <td colspan="3">
              <a href="Admin_Galon_Tambah.php">
                <button class="btn btn-primary">Tambah Data</button>
              </a>
            </td>
            <!-- <td id="total_harga"> -->
            <td>
              <a href="Admin_Galon_Edit.php">
