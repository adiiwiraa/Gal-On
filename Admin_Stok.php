              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box_section">
                    <a href="admin_Galon.php">
                      <div class="tiles_img"></div>
                      <h3 class="tile_text">Data Barang</h3>
                      <p class="lorem_text">Melihat Data Barang yang tersedia </p>
                    </a>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box_section">
                    <a href="Admin_refill.php">
                      <div class="tiles_img_1"></div>
                      <h3 class="tile_text">Data Refill Water</h3>
                      <p class="lorem_text">Melihat Data Refill Water yang tersedia</p>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="carousel-item">
            <div class="services_section_2 layout_padding">
              <div class="row">
                <div class="col-md-12">
                  <div class="box_section">
                    <a href="Admin_Supplier.php">
                      <div class="tiles_img_1"></div>
                      <h3 class="tile_text">Data Supplier</h3>
                      <p class="lorem_text">Dapat MelihatData Supplier</p>
                    </a>
                  </div>
                </div>
              </div>
