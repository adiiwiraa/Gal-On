...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE `supplier` SET `Nama_Supplier`='$nama',`Alamat_Supplier`='$alamat',`Kontak_Supplier`='$kontak' WHERE ID_Supplier = '$id_Supplier'";

    echo "alert('Data Sudah diubah, Silahkan cek data yang diperbarui')";
    // Jalankan query
...
<body>
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-lg-6">
                <h1 class="text-center mb-4"><br>Edit Data Supplier</h1>
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="kontak_supplier" id="Kontak_Supplier">
                    </div>
