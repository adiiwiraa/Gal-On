...
<body>
  ...
  <div class="about_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div><img src="images/img-1.png" class="image_2"></div>
        </div>
        <div class="col-md-6">
          <h1 class="services_taital"><span>About </span> <img src="images/water_smol.png"> <span
              style="color: #1f1f1f">Us</span></h1>
          <p align=justify class="ipsum_text">Gal-On adalah perusahaan yang bergerak dalam penyediaan galon dan air
            minum kemasan berkualitas tinggi. Kami mengerti betapa pentingnya akses mudah dan aman terhadap air minum
            yang segar dan terjaga kebersihannya.</p>
          <div class="contact_bt_1"><a href="about-2.php">READ MORE<span class="contact_padding"><img
